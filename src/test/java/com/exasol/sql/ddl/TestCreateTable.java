...
class TestCreateTable {
    ...
    void testCreateTableWithBooleanColumn() {
        final Column column = this.createTable.booleanColumn(BOOLEAN_COLUMN_NAME).getColumns().get(0);
    ...
    void testCreateTableWithCharColumn() {
        final Column column = this.createTable.charColumn(CHAR_COLUMN_NAME, CHAR_SIZE).getColumns().get(0);
    ...
    void testCreateTableWithDateColumn() {
        final Column column = this.createTable.dateColumn(DATE_COLUMN_NAME).getColumns().get(0);
